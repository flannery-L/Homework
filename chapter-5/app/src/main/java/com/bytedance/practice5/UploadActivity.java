...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part image = MultipartBody.Part.createFormData("image", "cover.png",
                RequestBody.create(MediaType.parse("multipart/form-data"), coverImageData));
        Call<UploadResponse> call = api.submitMessage(Constants.STUDENT_ID,"",from,toP,contentP,image,Constants.token);
        call.enqueue(new Callback<UploadResponse>() {
            ...
            public void onResponse(final Call<UploadResponse> call, final Response<UploadResponse> response) {
                ...
                final UploadResponse List = response.body();
                if (List == null ) {
                    return;
                }
                finish();

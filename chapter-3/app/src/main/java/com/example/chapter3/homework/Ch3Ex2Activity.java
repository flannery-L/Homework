...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator21 = ObjectAnimator.ofFloat(target,
                "scaleX",
                1.0f,2.0f);
        animator21.setDuration(Integer.parseInt(durationSelector.getText().toString()));
        animator21.setRepeatCount(ObjectAnimator.INFINITE);
        animator21.setRepeatMode(ObjectAnimator.REVERSE);
        ObjectAnimator animator22 = ObjectAnimator.ofFloat(target,
                "scaleY",
                1.0f,2.0f);
